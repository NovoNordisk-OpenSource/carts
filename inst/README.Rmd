...
releases, which currently follow a frequency of about 4 weeks. All releases follow [semantic versioning](https://semver.org/), are [tagged](https://github.com/NovoNordisk-OpenSource/carts/tags) and notable changes are reported in a [changelog](https://github.com/NovoNordisk-OpenSource/carts/blob/main/CHANGELOD.md).
